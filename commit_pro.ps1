...
git add voice/tools/briefing_tools.py voice/tools/system_control.py `
        ...
        voice/tools/obsidian_tools.py voice/tools/graphiti_tools.py

git commit -m "feat(PRO): briefing + calendar_auth + smoke_test + SETUP_PRO.md + Obsidian + Graphiti
...
- system_control.py: briefing, estado rapido, busca en el navegador + Obsidian + Graphiti
- mate_orb.spec: briefing_tools + obsidian_tools + graphiti_tools en hiddenimports
- SETUP_PRO.md: guia completa de configuracion PRO
- mate_pro_test.py: smoke test de todos los modulos PRO
- tools/obsidian_tools.py: integracion Obsidian Local REST API
- tools/graphiti_tools.py: cliente del grafo de memoria Graphiti via backend API"
